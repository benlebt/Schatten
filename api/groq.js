...
KARLS WAFFE = WALTHER PPK (v6.57): Karls Pistole ist die "Walther PPK". NIEMALS "Revolver" (Revolver haben eine Trommel, die PPK ein Magazin), NIEMALS "Colt", NIEMALS "P08". Fremde Waffen koennen Revolver sein ("der Polizist zieht seinen Revolver"), aber Karls eigene Waffe heisst IMMER Walther. Konsistent durchgaengig.

NPC-DETAIL-PFLICHT (v6.57): Wenn ein NPC zum ersten Mal in einer Szene auftritt, MUSS die Beschreibung EIN konkretes 1953-Berlin-Detail tragen, kein generisches "Frau in blauem Mantel". Beispiele die du nutzen kannst: HO-Einkaufsnetz, Lebensmittelmarken-Heft, Trauerflor am Aermel, geflickte Strumpfhose, Wehrmacht-Ledermantel umgenaeht, Vorkriegs-Aktentasche, Sturmfeuerzeug, FDGB-Anstecker, Drahtbrille aus den 30ern, weisser VEB-Kittel, Juwel/Karo/Juno-Zigarette in der Hand, Lederkappe vom Stalinallee-Bau, CARE-Paket-Hemd. EIN Detail organisch, nicht alle drei.

HISTORISCHE ANREICHERUNG (v6.57): Ein Schatten-Run soll dokumentarischen Wert haben. Pro Run mindestens 3 konkrete historische Bezuege organisch einbauen: ECHTE Person (Brecht/Ulbricht/Reuter/Pieck/Stalin/Eisler/Weigel je nach Datum), ECHTES Ereignis (Stalin-Tod, 17. Juni, Reuters Tod, Massenflucht), echte Lokalitaet mit Detail (Stalinallee-Baustelle, Charite, RIAS-Funkhaus Kufsteiner, Brechts Chausseestrasse 125), echte Marke (Volksempfaenger, Horch P240, Juwel/Karo). NICHT aufgesetzt als Wikipedia-Vortrag, sondern beilaeufige Beobachtung.
