# KONZEPT: Baukasten-First — einheitliches Aktions-Interface (Benjamin, v649/650)
...
ganz ersetzen durch das Baukasten-/Puzzle-System. Benjamins Vision: ein EINHEITLICHES Interface für alle
Aktionen nach dem Muster **Akteur — Verb — Ziel**.

## Benjamins konkrete Befunde (Screenshots Run v643, Bahnhof Friedrichstraße Sz10)
...
- Die Buttons sind KI-getrieben und daher oft "schwachsinn" (Benjamin wörtlich).

## Benjamins Ziel-Interface
...
```
Offene Grundsatzfrage von Benjamin: "Ob das ganze Spiel mit dem Puzzle-Baukasten funktionieren sollte/könnte
und wir so ein einheitliches Interface hätten für alle Aktionen."

## Redundante Personen-Verben (Benjamins Einschätzung, zu prüfen)
Im NPC-Popup sind laut Benjamin einige Verben redundant geworden, seit jeder anwesende NPC Aktionen hat:
...
1. Verliert das Spiel an "Atmosphäre", wenn die KI keine situativen Optionen mehr vorschlägt? Die KI-Vorschläge
   geben manchmal Ideen, auf die der Spieler nicht käme. Gegenargument Benjamin: die meisten sind Unsinn.
...
- Schritt 1: Redundante NPC-Verben aufräumen (beobachten/beschützen/in-sicherheit-bringen prüfen+entfernen).
  Klein, risikoarm, sofort spürbar. Braucht Benjamins Freigabe pro Verb.
...
## Status
NOCH NICHTS GEBAUT. Reine Konzept-Festschreibung auf Benjamins Wunsch ("du musst das alles mitloggen").
Nächster konkreter Schritt wartet auf Benjamins Entscheidung, wo wir anfangen.
